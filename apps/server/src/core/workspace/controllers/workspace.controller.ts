...
import { McpPromptService } from '../../mcp/mcp-prompt.service';
...
export class WorkspaceController {
  ...
  async getMcpPreview(
    ...
    const prompt = await this.mcpPromptService.buildSystemPrompt(workspace.id);
    const tools = this.mcpToolRegistry.list().map((t) => ({
      name: t.name,
