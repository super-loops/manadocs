...
import InvitationEmail from '@manadocs/transactional/emails/invitation-email';
import { GroupUserRepo } from '@manadocs/db/repos/group/group-user.repo';
import InvitationAcceptedEmail from '@manadocs/transactional/emails/invitation-accepted-email';
...
export class WorkspaceInvitationService {
  ...
  async acceptInvitation(
    ...
    if (invitedByUser) {
      ...
      await this.mailService.sendToQueue({
        ...
        subject: `${newUser.name} has accepted your Manadocs invite`,
  ...
  async sendInvitationMail(
    ...
    await this.mailService.sendToQueue({
      to: inviteeEmail,
      subject: `${invitedByName} invited you to Manadocs`,
      template: emailTemplate,
    });
  }
}
