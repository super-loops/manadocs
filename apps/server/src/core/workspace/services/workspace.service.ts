...
import { GroupRepo } from '@manadocs/db/repos/group/group.repo';
...
import { isPageEmbeddingsTableExists } from '@manadocs/db/helpers/helpers';
...
export class WorkspaceService {
  ...
  constructor(
    ...
    @InjectQueue(QueueName.ATTACHMENT_QUEUE) private attachmentQueue: InMemoryQueue,
    @InjectQueue(QueueName.BILLING_QUEUE) private billingQueue: InMemoryQueue,
