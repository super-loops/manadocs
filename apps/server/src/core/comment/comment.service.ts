...
import { CommentRepo } from '@manadocs/db/repos/comment/comment.repo';
import { Comment, Page, User } from '@manadocs/db/types/entity.types';
...
export class CommentService {
  ...
  constructor(
    ...
    private generalQueue: InMemoryQueue,
