...
export async function getWorkspaceMcpPreview(): Promise<IMcpPreview> {
  const req = await api.post<IMcpPreview>("/workspace/mcp-preview");
  return req.data;
}
